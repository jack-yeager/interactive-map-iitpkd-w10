...
folium.Marker(location=[10.799134430915721, 76.81813182028293],tooltip="<strong>Taste of Malabar</strong>",popup=popup_h1,icon=ricon_h1).add_to(map)#for displaying everything in the given icon
map.save("h1.html")
