...
folium.Marker(location=[10.8017955754564, 76.81849606364607],tooltip="<strong>Staff Quaters</strong>",popup=popup_st,icon=ricon_st).add_to(map)#for displaying everything in the given icon
map.save("st.html")
