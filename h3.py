...
folium.Marker(location=[10.797984370712905, 76.81832584827522],tooltip="<strong>Taste of Malabar</strong>",popup=popup_h3,icon=ricon).add_to(map)#for displaying everything in the given icon
map.save("h3.html")
