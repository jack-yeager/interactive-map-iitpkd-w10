...
folium.Marker(location=[10.799550455187008, 76.8222669062808],tooltip="<strong>Hostel 2</strong>",popup=popup_h2,icon=ricon_h2).add_to(map)#for displaying everything in the given icon
map.save("h2.html")
