...
folium.Marker(location=[10.80002997087941, 76.81874784806095],tooltip="<strong>Cafe Day Cafeteria</strong>",popup=popup_cdc,icon=ricon_cdc).add_to(map)#for displaying everything in the given icon
map.save("cdc.html")
